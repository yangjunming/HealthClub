				...
				<div id="page-wrapper">
						...
						<div class="form-group">
								<div class="row">
										<div class="col-md-4"></div>
										<div class="col-md-4">
												<label>收费标准:</label> <input type="text" id="charge" name="charge" value=""><label>元/小时</label>
										</div>
										<div class="clearfix"></div>
								</div>
						</div>
						...
						<div class="form-group">
								<div class="row">
										<div class="col-md-4"></div>
										<div class="col-md-4">
												<label class="control-label ">负责房间号：</label> <select id="homeNum" name="homeNum"
														style="width: 86.5px; padding-left: 20px">
...
//加载房间
	$.ajax({
    type: "get",
    url: "<%=basePath%>home/getHomeNotTechnician?id="+id+"",
			data : {},
			dataType : "json",
			async:false,
			success : function(data) {
				if(data.length==0){
					$("#homeNum").append("<option value='0'>没有空闲房间可选择</option>");
				}else{
