		...
		<div id="wrapper">
				...
				<nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
						...
						<div class="nav navbar-nav navbar-right">
								${sessionScope.User.name}(会员) <a class="btn-success btn" href="<%=basePath%>loginout" style="padding-top: 0px;">退出</a>
						</div>
						<div class="navbar-default sidebar" role="navigation">
								<div class="sidebar-nav navbar-collapse">
										<ul class="nav" id="side-menu">
												<li><a href="<%=basePath%>views/index.jsp"><i class="fa fa-dashboard fa-fw nav_icon"></i>首页</a></li>
												<li style="border-right: 3px solid #fff;"><a href="<%=basePath%>/views/customer/member-reserve.jsp"><i
																class="fa fa-dashboard fa-fw nav_icon"></i><strong>预约&nbsp;&gt;&gt;</strong></a></li>
												<li><a href="<%=basePath%>memberCard/getMemCard?id=${User.id}"><i
																class="fa fa-dashboard fa-fw nav_icon"></i>会员卡</a></li>
												<li><a href="<%=basePath%>memberCard/getMemCardPoint?id=${User.id}"><i
																class="fa fa-dashboard fa-fw nav_icon"></i>积分兑换</a></li>
										<li>
